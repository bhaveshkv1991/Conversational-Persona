...
export const MicIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        ...
        <path d="M12 16.5A4.5 4.5 0 0 1 7.5 12H6a6 6 0 0 0 6 6 6 6 0 0 0 6-6h-1.5a4.5 4.5 0 0 1-4.5 4.5Z" />
    </svg>
);

export const MicSlashIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
export const HandRaisedIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 0 1-5.84 7.38v-4.82m5.84-2.56a14.98 14.98 0 0 0-5.84-2.56m0 0a14.982 14.982 0 0 1-5.84-2.56m5.84 2.56V21m-5.84-7.38v-4.82a14.982 14.982 0 0 1 5.84-2.56m-5.84 2.56L4.73 4.73m0 0a.75.75 0 0 1 1.06 0l12 12a.75.75 0 0 1-1.06 1.06l-12-12a.75.75 0 0 1 0-1.06Z" />
  </svg>
);

export const BotIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 7.5V6.108c0-1.135.845-2.098 1.976-2.192.373-.03.748-.03 1.125 0 1.131.094 1.976 1.057 1.976 2.192V7.5M8.25 7.5h7.5M8.25 7.5V9a.75.75 0 0 1-.75.75H5.25a.75.75 0 0 1-.75-.75V7.5m11.25 0V9a.75.75 0 0 0 .75.75h2.25a.75.75 0 0 0 .75-.75V7.5m-9 12V18a.75.75 0 0 0 .75.75h3a.75.75 0 0 0 .75-.75v-1.5m-4.5 0h4.5m4.5 0h-4.5m-4.5 0H9m-3.75 0H5.25c-.414 0-.75.336-.75.75v3c0 .414.336.75.75.75h3.75m0 0v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V19.5m0 0h3.75c.414 0 .75-.336.75-.75v-3c0-.414-.336-.75-.75-.75h-3.75m0 0h.008v.015h-.008V19.5Z" />
  </svg>
);
